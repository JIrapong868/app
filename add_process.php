...
$sql = "INSERT INTO products (ProductName, Picture, Category,  ProductDescription, Price, QuantityStock)
    VALUES('$Name','$Picture','$Category',' $Descript', $Price,$Quantity)";

if ($conn->query($sql) == true) {
    echo "เพิ่มข้อมูลได้แล้วค่ะ New record created  ";
} else {
    echo "เพิ่มข้อมูลไม่ได้แล้วค่ะ Error: " . $sql . "<br>" . $conn->error;
}
